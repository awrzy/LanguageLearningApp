...
{
    public partial class QuizControlDe2 : UserControl
    {
        ...
        private void InitializeSentences()
        {
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                using (SqlCommand cmdSentences = new SqlCommand("SELECT Id, QuestionText FROM SentencesDe", conn))
                ...
                foreach (var (sentenceId, questionText) in loadedSentences)
                {
                    ...
                    using (SqlCommand cmdWords = new SqlCommand("SELECT Word, WordOrder FROM SentenceWordsDe WHERE SentenceId = @id", conn))
                    {
